...
public class SimpleActivity extends Activity {
    ...
    public static final String SURVEY_HASH = "V8C3Y7R";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        System.out.println("RESULTCDE IS:" + resultCode);
         ...
         if (resultCode == RESULT_OK) {
            ...
            Toast t = Toast.makeText(this, "Response recorded", Toast.LENGTH_LONG);
        }
